...
monthText:"Month",dayText:"Day",yearText:"Year",hourText:"Hours",minuteText:"",secText:"ID Picker",ampmText:"&nbsp;",stepHour:1,stepMinute:1,stepSecond:1,separator:" "},x=function(r){function l(a,b,c){return void 0!==n[b]?+a[n[b]]:void 0!==c?c:A[m[b]]?A[m[b]]():m[b](A)}function p(a,b){return Math.floor(a/b)*b}function o(a){var b=l(a,"h",0);return new Date(l(a,"y"),l(a,"m"),l(a,"d",1),l(a,"ap")?b+12:b,l(a,"i",0),l(a,"s",0))}var k=b(this),s={},d;if(k.is("input")){switch(k.attr("type")){case "date":d=
